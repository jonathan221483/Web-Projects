...
if((isset($_SESSION['Admin']) && $_SESSION['Admin']=='False') && ((isset($_SESSION['User'])) && ($_SESSION['User']!='Teacher')))
{
...
<table class="table table-hover">
  <thead>
    <tr>
      ...
      <?php
      if(isset($_SESSION['Admin']) && $_SESSION['Admin']=="True")//if current user is admin
        echo'
...
{
  echo'<tr>
      <th scope="row">'.$results['Student_ID'].'</th>
      <td>'.$results['Student_Name'].'</td>
      <td>'.$results['Student_Surname'].'</td>';//show table row
      ;
      if(isset($_SESSION['Admin']) && $_SESSION['Admin']=="True")//if the current user is admin
        echo'<td>'.$results['Student_Login'].'</td>
      <td>'.$results['Student_Password'].'</td>';//show table row
      echo'</tr>';
}
?>  
</tbody>
